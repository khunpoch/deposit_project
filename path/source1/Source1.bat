...
set CSV_DIR=C:\path\source1\csv_file
...
set CONTROL_FILE=C:\path\source1\CONTROL_FILE\source_control_1.ctl
set LOG_FILE=C:\path\source1\LOG_FILE\log_file.log
set BAD_FILE=C:\path\source1\BAD_FILE\bad_file.bad
