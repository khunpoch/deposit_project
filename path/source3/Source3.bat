...
set CSV_DIR=C:\path\source3\csv_file
...
set CONTROL_FILE=C:\path\source3\CONTROL_FILE\source_control_3.ctl
set LOG_FILE=C:\path\source3\LOG_FILE\log_file.log
set BAD_FILE=C:\path\source3\BAD_FILE\bad_file.bad
